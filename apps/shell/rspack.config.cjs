...
const SPEAKING_REMOTE =
  process.env.MFE_SPEAKING_REMOTE || 'http://localhost:4202/mf-manifest.json';
const PROGRESS_REMOTE =
  process.env.MFE_PROGRESS_REMOTE || 'http://localhost:4203/mf-manifest.json';
const STUDIO_REMOTE =
  process.env.MFE_STUDIO_REMOTE || 'http://localhost:4204/mf-manifest.json';
  ...
  plugins: [
    ...
    new ModuleFederationPlugin({
      ...
      remotes: {
        ...
        mfe_speaking: `mfe_speaking@${SPEAKING_REMOTE}`,
        mfe_progress: `mfe_progress@${PROGRESS_REMOTE}`,
        mfe_studio: `mfe_studio@${STUDIO_REMOTE}`,
      },
      shared,
    }),
  ],
